...
from recipe_generation.utils.output_utils import prepare_output
...
def RE_recipes(img_path):

  data_dir = './recipe_generation/data'
  ...
  image_folder = os.path.join(img_path)
